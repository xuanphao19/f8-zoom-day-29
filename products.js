...
//                 <a
//                     class="thumb-link link-detail position-absolute inset-full flex-center p-4 border-bottom"
...
//   itemsList.innerHTML = "Bạn chưa chọn sản phẩm nào!";
...
//               <div
//                 class="card-thumbs position-relative pt-100 mb-2 border border-black border-opacity-50 rounded-4">
//                 <a
//                   class="thumb-link link-detail position-absolute inset-full flex-center p-2"
//                   href="/product-details.html?id=${favorite.id}">
//                   <img loading="lazy"
//                     class="card-img object-fit-contain p-4 bg-black bg-opacity-05 rounded-4"
...
// document.onclick = manageProductDetail;
...
//         <div class="col-lg-6 col-xl-5 col-12 col-md-10 mx-auto h-100 col" style="min-height: 386px">
...
//         <div class="col-lg-6 col-xl-7 col-12 col-md-10 mx-auto d-flex justify-content-between align-items-stretch col">
...
//             <div class="p-3 mt-3 border border-2 rounded-4 shadow-sm">
...
//                   10%
//                 </span>
//                 <div class="fs-2 fw-medium px-4 py-3">$ ${detail.discountPercentage}</div>
//               </div>
//               <div class="d-flex align-items-center px-4 fs-3">
//                 <div class=" flex-grow-1">
//                   <p class="">Brand: ${detail.brand}</p>
//                   <p class="">Shipping: ${detail.shippingInformation}</p>
//                 </div>
//                 <div class="p-4 w-25">
...
//   }
//   // Không xóa nếu đang ở trang chi tiết
...
function renderProductList(products) {
  if (productList) {
    productList.innerHTML = products.map((product) => renderProduct(product)).join("");
  }
}
    ...
    element.innerHTML = `
      <div class="container mx-auto d-flex py-3 row">
        <div class="col-lg-6 col-xl-5 col-12 col-md-10 mx-auto h-100 col" style="min-height: 386px">
          ...
          <p class="text-center px-4 mt-3">Shipping: ${detail.description || "Thông tin vận chuyển không có"}</p>
        </div>
        <div class="col-lg-6 col-xl-7 col-12 col-md-10 mx-auto d-flex justify-content-between align-items-stretch col">
          <div class="p-5 flex-grow-1 rounded-4 bg-secondary shadow-sm d-flex flex-column">
            <h2 class="text-body fs-1">Featured Shops Modi, est rem voluptas nam!</h2>
